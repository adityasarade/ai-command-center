...
const SITE = 'https://aicommandcenter.vercel.app';
...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      'One gateway, every AI project, one dashboard. Self-hosted LLM usage & cost tracking with zero dependencies.',
    type: 'website',
    url: SITE,
  },
  twitter: {
    ...
    title: 'AI Command Center',
    description: 'Self-hosted LLM usage & cost dashboard. Any language, one command.',
  },
  icons: {
    icon: [
      {
