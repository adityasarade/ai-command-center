...
npx ai-command-center clear   # removes the demo data whenever you want`} />
      ...
      <CodeBlock lang="bash" code={`npm install -g ai-command-center
...
aicc --help`} />
      ...
      <table>
        ...
        <tbody>
          <tr><td><code>start</code></td><td>Start the gateway + dashboard (default)</td></tr>
          <tr><td><code>demo</code></td><td>Seed 14 days of sample data (tagged, removable)</td></tr>
