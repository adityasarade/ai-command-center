    ...
    <>
      ...
      <div className="tablewrap" style={{ margin: '20px 0' }}>
        <table className="cmp">
          <thead>
            <tr>
              <th>Tool</th><th>Integration</th><th>Self-host</th><th>Lang-agnostic</th>
              <th>Primary focus</th><th>Also a gateway?</th><th>License</th>
            </tr>
          </thead>
          <tbody>
            {ROWS.map((r) => (
      ...
      <p>
        Be clear about what it is <strong>not</strong>. It is not a tracing or evaluation platform: no span
        trees, no agent-step traces, no LLM-as-judge scoring, no datasets, no prompt playground. It is
        not a router: no load balancing, retries, failover, or semantic caching. It is not SaaS, and it
        is not a billing engine. On every one of those axes, another tool on this list does more.
      </p>
      ...
      <div className="callout">
        <strong>Who it&apos;s for:</strong> teams that want dead-simple, self-hosted, language-agnostic,
